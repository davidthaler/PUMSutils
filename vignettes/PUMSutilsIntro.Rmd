...
You can also provide data already grouped using `dplyr::group_by`.
In this case, the grouping variable is added as a new level, 
and you pass `NULL` if you do not want to add any new levels.
